...
function captureImage() {
    ...
    canvas.toBlob(function (blob) {
        ...
        console.log("âœ… Image captured:", filename);
...
async function analyzeImage() {
    ...
    analyzeButton.innerHTML = '<span>â³ Analyzing with AI...</span>';
    ...
    resultsContent.innerHTML = `
        <div class="loading-analysis">
            ...
            <h3>ðŸ¤– AI is analyzing your image...</h3>
    ...
    try {
        ...
        analyzeButton.innerHTML = '<span>ðŸ¤– Analyze with AI</span>';
    }
}
...
async function fetchRecyclingCenters() {
    ...
    function createAnalysisHTML(result, centers) {
        ...
        console.log('ðŸ” Detected objects:', result.detected_objects);
        ...
        console.log('ðŸ“Œ Using detection:', detectedItem);
        ...
        <div class="analysis-result">
            ...
            <div class="centers-section">
                <h4>ðŸ“ Nearby Recycling Centers</h4>
    ...
    // Normalize YOLO object names to database keys
...
function performMockAnalysis() {
    const mockResults = {
        ...
        recommendations: ['â™»ï¸ Recycle the bottle at nearest center'],
        total_points: 10,
        objects_found: 1,
        carbon_saved_kg: 0.5
    };
